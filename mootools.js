...
function makeBingo(items) {
  ...
  items.forEach(function (s) {
    ...
    li.addEventListener("click", toggleBingoCell);
  });
...
function storeBingo() {
  ...
  localStorage.setItem(
    "bingoClass",
    document.querySelector("#bingo").className
  );
}
...
function loadBingo() {
  ...
  if (bingo) {
    ...
    document
      .querySelectorAll("#bingo > li")
      .forEach((e) => e.addEventListener("click", toggleBingoCell));
  }
}
